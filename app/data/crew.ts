...
export const roleCards: RoleData[] = [
  ...
  },
  {
    ...
    members: [
      ...
      { name: '吳欣潁', title: 'Engineer',          initials: 'XY', avatarUrl: null, gradientClass: gradient(3) },
      { name: '蘇胤祥', title: 'Engineer',          initials: 'YX', avatarUrl: null, gradientClass: gradient(4) },
